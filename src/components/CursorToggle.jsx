...
export default function CursorToggle() {
    ...
    return (
        <div className="hidden lg:flex absolute top-24 right-16 z-[50] flex-col items-end gap-2">
            <span className="font-western text-[14px] text-[#941313] uppercase tracking-[0.4em] font-bold drop-shadow-sm pr-1">
                Interface de Mira
            </span>
            ...
            <div className="flex bg-black/80 backdrop-blur-md border border-white/20 p-1.5 rounded-sm shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                <button
                    ...
                    className={`px-6 py-2.5 text-[14px] font-western uppercase cursor-pointer tracking-widest transition-all duration-300 ${cursorType === 'normal'
                        ? 'bg-white text-black'
                ...
                <button
                    ...
                    className={`px-6 py-2.5 text-[14px] font-western cursor-pointer uppercase tracking-widest transition-all duration-300 ${cursorType === 'arma'
